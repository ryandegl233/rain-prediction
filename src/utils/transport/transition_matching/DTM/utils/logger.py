...
class TensorboardLogger:
    def __init__(
        self, place="./runs/", file_dir="./logs/", file_logger_name=None, random_id=True, tb_comment=None, **tb_kwargs
    ) -> None:
        """tensorboard logger
    ...
    @beartype
    def log_images(self, tag: str, images: Tensor, step: int, *, dataformats: str = "NCHW"):
